...
pub use byteorder::{WriteBytesExt, BigEndian };
...
pub fn gen_oracle_query_id(sender_id: &String,
                       nonce: i64,
                       recipient_id: &String,
) -> String {
...
fn test_base58check() {
    ...
    assert_eq!(decodebase58check(&key), [49, 251, 48, 224, 136, 182, 49, 247, 149, 81, 107, 110, 171, 235, 247, 240, 41, 195, 59, 34, 112, 140, 205, 205, 96, 12, 98, 243, 187, 230, 36, 51]);
...
fn test_gen_contract_id() {
    ...
    assert_eq!(gen_contract_id(&address, 2), String::from("ct_5ye5dEQwtCrRhsKYq8BprAMFptpY59THUyTxSBQKpDTcywEhk"));
}
...
fn test_gen_oracle_query_id() {
    ...
    assert_eq!(gen_oracle_query_id(&sender_address, nonce, &oracle_address), expected_result);
}
